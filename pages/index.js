...
import Process_ from "../components/Process/Process"

import { Page } from "../components/Pages/pageStyles"

const Main = styled.main`
	display: grid;
	grid-template-rows: 40rem auto 40rem auto;
	//header process  services section2
`
		...
		<>
			<Page>
				...
				<Main>
					...
					<Process_ />
					<Services>
						<Services_title>FINANCIAL SERVICES</Services_title>
					</Services>
					<Section2>
						<Section_title2>FINANCIAL SERVICES</Section_title2>
						<Components_ />
					</Section2>
				</Main>
				<Footer_ />
